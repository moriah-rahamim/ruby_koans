...
class AboutSymbols < Neo::Koan
  ...
  in_ruby_version("mri") do
    ...
    camelCaseName = "What is the sound of one hand clapping?"
    TitleCaseName = "What is the sound of one hand clapping?"
    def test_constants_become_symbols
      all_symbols_as_strings = Symbol.all_symbols.map { |x| x.to_s }

      assert_equal true, all_symbols_as_strings.include?("RubyConstant")
      assert_equal true, all_symbols_as_strings.include?("camelCaseName")
      assert_equal true, all_symbols_as_strings.include?("TitleCaseName")
    end
  end
